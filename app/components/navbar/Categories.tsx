...
export const categories = [
  ...
  },
  {
    label: 'Windmills',
    icon: GiWindmill,
    description: 'This property is located near the windmills.',
  },
  {
    label: 'Modern',
    icon: MdOutlineVilla,
    description: 'This property is located near the city.',
  },
  {
    label: 'Countryside',
    icon: TbMountain,
  ...
  },
  {
    label: 'Barns',
    icon: GiBarn,
    description: 'This property is located in the barn.',
  },
  {
    label: 'Lux',
    icon: IoDiamond,
